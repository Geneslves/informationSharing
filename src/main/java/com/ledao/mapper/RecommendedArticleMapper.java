...
public interface RecommendedArticleMapper {
    ...
    @Insert("INSERT INTO t_recommended (similarUserIds,allRecommendedIds,time,userId, articleId1, articleId2, articleId3, articleId4, articleId5, articleId6, articleId7, articleId8, articleId9, articleId10) " +
